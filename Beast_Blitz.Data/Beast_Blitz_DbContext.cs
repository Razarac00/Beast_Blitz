...
namespace Beast_Blitz.Data
{
    public class Beast_Blitz_DbContext : DbContext
    {
        ...
        {
            //Server=tcp:project-zero-john.database.windows.net,1433;Initial Catalog=Beast_Blitz_Db;Persist Security Info=False;User ID={your_username};Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;
