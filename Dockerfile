...
WORKDIR /src
COPY ["Beast_Blitz/Beast_Blitz.Client/Beast_Blitz.Client.csproj", "Beast_Blitz/Beast_Blitz.Client/"]
RUN dotnet restore Beast_Blitz/Beast_Blitz.Client/Beast_Blitz.Client.csproj
COPY . .
WORKDIR /src/Beast_Blitz/Beast_Blitz.Client
